...
.c-menu > ul .c-menu__item.active .c-menu__item__inner {
  border-left-color: #5f9cfd;
  background-color: #1e3e6f;
}
.c-menu > ul .c-menu__item.active .c-menu__item__inner i {
  color: #5f9cfd;
}
.c-menu
  > ul
...
.c-menu > ul .c-menu__item.active .c-menu__item__inner:before {
  height: 36px;
  opacity: 1;
}
.c-menu > ul .c-menu__item:not(.active):hover .c-menu__item__inner {
