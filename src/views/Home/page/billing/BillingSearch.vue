            ...
            <div class="row no-gutters align-items-center">
              <div class="col-md-6">
                <div class="form-wrap bg-white">
                  <h1 class="btm-sep pb-3 mb-5">Billing Search</h1>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="form-group position-relative">
                        <span class="zmdi zmdi-center-focus-strong"></span>
                        <input
                          type="password"
                          id="password"
                          class="form-control"
                    ...
                    <div class="col-12 mt-30">
                      ...
                      <router-link to="/billing">
                        <button
                          type="submit"
                          id="submit"
                          class="btn btn btn-custom btn-dark btn-block"
                        >
                          Search
                        </button>
                      </router-link>
              ...
              <div class="col-md-6">
                <div class="content text-center">
                  <div class="border-bottom pb-5 mb-5">
                    <h2 class="c-black">HMO</h2>
                  </div>
                  <h5 class="c-black mb-4 mt-n1">Power By Alturas</h5>
                  <div class="socials">
